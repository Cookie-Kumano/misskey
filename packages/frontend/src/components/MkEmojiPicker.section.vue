...
<section v-if="!hasChildSection" v-panel style="border-radius: var(--MI-radius); border-bottom: 0.5px solid var(--MI_THEME-divider);">
...
<section v-else v-panel style="border-radius: var(--MI-radius); border-bottom: 0.5px solid var(--MI_THEME-divider);">
	<header class="_acrylic" @click="shown = !shown">
